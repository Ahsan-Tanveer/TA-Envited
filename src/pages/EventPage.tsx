...
function EventPage() {
  return (
    <Box pt={{xs: 0, xl: 8}} px={{xs: 0, xl: 3.5}} sx={{ display: { xs: 'block', xl: 'flex'}, flexDirection: {xs: 'unset', xl: 'row-reverse'}, maxWidth: { xs: '590px', xl: '1170px'}, mx: 'auto' }}>
      ...
      <Box sx={{ width: { xs: '100%', xl: '50%' }, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        <Box width={'100%'}>
          <Box sx={{ display: {xs: 'flex', xl: 'none'}, justifyContent: 'center', img: {width: '100%'}, mt: {xs: 0, md: 7} }}>
            <img src={'Birthday cake.png'} alt="Landing Page Image" />
          </Box>
          ...
          <Box p={{ xs: 2.5, md: '20px 0' }}>
            ...
            <Description variant="body1" color={'neutral.main'}>Hosted by <strong>Elysia</strong></Description>
          </Box>
