    ...
    <Box pt={8} px={3.5} sx={{ display: { xs: 'block', xl: 'flex'}, maxWidth: '1175px', mx: 'auto' }}>
      <Box sx={{ width: { xs: '100%', xl: '50%' } }}>
        <Box sx={{ display: {xs: 'none', xl: 'flex'}, justifyContent: 'center', alignItems: 'center' }}>
          <CreateEventCard startTime={startTime}  endTime={endTime} location={location} handleStartTime={handleStartTime} handleEndTime={handleEndTime} handleLocation={handleLocation} />
        </Box>
      </Box>
      <Box sx={{ width: { xs: '100%', xl: '50%' }, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        <Box width={'100%'}>
          ...
          <Description variant="body1" color={'neutral.main'}>Please take us about your event prefrences</Description>
