...
import { Box, Card, CardContent, CardProps, FormControl, InputLabel, MenuItem, Select, SelectChangeEvent, TextField } from '@mui/material';
...
const CardWithContent = ({ startTime, endTime, location, handleStartTime, handleEndTime, handleLocation }: CreateEvenrCardProps) => {
  return (
    <StyledCard variant="outlined">
      <CardContent>
        <Box sx={{ width: '100%', height: '150px' , border: '1px solid #E0E0E0', borderRadius: '3px', mb: 2, input: { visibility: 'hidden' }, img: { width: '100%', height: '100%', objectFit: 'cover' } }} onClick={() => {  }}>
